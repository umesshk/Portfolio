    ...
    <div className="w-full py-8 md:py-10">
      ...
      <div className="w-full container mx-auto px-4 sm:px-6 md:px-10 mt-5 md:mt-5">
        <motion.p variants={slideUp(0.3)} initial="initial" whileInView="animate" className="text-white text-base md:text-lg -tracking-tight">
          I am a passionate Full-Stack Developer with a love for developing <span className="font-bold">Web applications</span>. Currently, I&apos;m a <span className="font-bold">Third-year</span> B.Tech Computer Science student at <span className="font-bold">Graphic Era Hill University</span>.
          <br /><br />
