...
export default function Navbar(){
    return <div className="container py-10 w-full mx-auto gap-10 items-center   flex justify-between ">
            ...
            <div className="flex gap-16 ">{NavItems.map((item: string,inex: number)=>{
                return <span className="text-white text-xl hover:text-purple-400 hover:cursor-pointer tracking-tight ">{item}</span>
            })}</div>
